...
import { press, site } from "../content";
  ...
  return (
    <section className="bg-white py-24">
      <div className="mx-auto max-w-2xl px-6 text-center lg:px-8">
        ...
        <p className="mt-6 text-lg leading-relaxed text-navy-950/60">{press.intro}</p>
        <p className="mt-2 text-sm text-navy-950/40">{site.supportEmail}</p>
        <Link
          to={press.ctaTo}
